...
void UIScene_LoadOrJoinMenu::GetSaveInfo()
{
    ...
    if(app.DebugSettingsOn() && app.GetLoadSavesFromFolderEnabled())
    {
        ...
        if(m_pSaveDetails==nullptr)
        {
            char savePackNameOrbis[] = "save";
            C4JStorage::ESaveGameState eSGIStatus= StorageManager.GetSavesInfo(m_iPad, nullptr, this, savePackNameOrbis);
        }
#endif
    ...
    else
    {
        ...
        if(m_pSaveDetails==nullptr)
        {
            char savePackName[] = "save";
            C4JStorage::ESaveGameState eSGIStatus= StorageManager.GetSavesInfo(m_iPad, nullptr, this, savePackName);
        }
		...
		case eSaveTransfer_GetSavesInfo:
			{
				...
				char savePackNameB[] = "save";
				C4JStorage::ESaveGameState eSGIStatus= StorageManager.GetSavesInfo(pClass->m_iPad,&UIScene_LoadOrJoinMenu::CrossSaveGetSavesInfoCallback,pClass,savePackNameB);
